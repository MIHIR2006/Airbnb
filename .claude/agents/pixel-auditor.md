...
```
src/components/listing/TitleRow.tsx:14: title font-size 24px, expected 22px (DESIGN.md typography.display-lg)
src/components/listing/HeroGrid.tsx:31: grid gap 12px, expected 8px (measured on reference)
```
